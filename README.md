...
SE DIMENTICHI LA PASSWORD (solo utente)


Clicca su "Password dimenticata?" → inserisci il tuo username 
→ il sistema ti dà una password temporanea (copiala subito)
→ accedi con quella → il sistema ti obbliga a crearne una nuova
